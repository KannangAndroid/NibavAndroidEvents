...
export const config = {
  databaseURI:
    process.env.DATABASE_URI || process.env.MONGODB_URI || 'postgresql://postgres:BOjaOKsJAipJf3cFGE13@database-1.cjjdq5xu7j2x.ap-south-1.rds.amazonaws.com/Nibavlifts',
